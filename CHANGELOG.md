...
> * keyboard input to FHIR Path field broken on Mac, due to bugs in macOS
    Flutter: https://github.com/flutter/flutter/issues/94633

* ### Faiadashu Example / Gallery
* Added demos of all the new capabilities listed for Faiadashu.
* Renamed package to `com.legentix.faiagallery`, in order for it to be globally unique (required for some Apple signing
  stuff)
* Beginning to rename Example to Gallery. Planning to have a much simpler example at some point. And then Gallery shows
  off everything.
